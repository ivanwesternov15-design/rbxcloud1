...
const App = {
    ...
    updateHomeStatsUI() {
        ...
        if (passiveEl) passiveEl.textContent = Auth.formatNumber(Auth.calculatePassiveIncome() * 60) + ' / мин';
    ...
    renderHome() {
        ...
        document.getElementById('home-passive').textContent = Auth.formatNumber(Auth.calculatePassiveIncome() * 60) + ' / мин';
